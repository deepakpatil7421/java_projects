...
5. Find source files
  ...
  - Navigate to `webpack:// -> [your/repo/path]] -> acme-components -> src` to find your component source files.
...
3. Run the dash layout you want to test
        ...
        # Import acme-components to your layout, then run it:
